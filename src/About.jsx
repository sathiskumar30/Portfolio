...
const About = () => {
  return (
     <div id="about" className="px-2 pl-20   py-4 max-sm:pl-3  text-black pb-10">
        <h1 className='text-[22px] font-bold max-sm:text-[18px]' id='about1' >About me</h1>
        <div className="pl-4 flex flex-col gap-2 max-sm:pl-1">
           <div className="flex flex-row gap-2 pt-3 max-sm:items-start">
           <img className='w-6  max-sm:w-7 max-sm:h-7 max-sm:mt-1' src="./next.png" alt="" />
             <p className='text-[17px] font-semibold'>I'm a Fresher, A 21 year boy from TamilNadu, very passionate about doing small things in a greater way.
             </p>
             </div>
             <div className="flex flex-row gap-2">
             <img className='w-6 max-sm:w-7 max-sm:h-7 max-sm:mt-1' src="./next.png" alt="" />
             <p className="text-[17px] font-semibold">
              Looking for a position in <b className='text-[#000000] text-[20px]'>Web development</b> to start my carrier.
             </p>
             </div>
             <div className="flex flex-row gap-2">
             <img className='w-6 max-sm:w-7 max-sm:h-7 max-sm:mt-1' src="./next.png" alt="" />
             ...
             <img className='w-6 max-sm:w-7 max-sm:h-7 max-sm:mt-1' src="./next.png" alt="" />
             <p className="text-[17px] font-semibold">
               Having knowledge of various <b className='text-[20px]'>Frontend Frameworks</b> and <b className='text-[20px]'>Libraries</b>,with hands on working with stuff on my own projects.
             </p>
             </div>
        </div>
        <div className="">
        ...
        <div className="flex flex-col gap-3 pt-4">
          <h1 className='font-bold text-[23px] max-sm:text-[22px]'>Professional Background</h1>
         <div className="flex flex-row gap-3 pl-4">
          <img className='w-6 h-8  max-sm:mt-1' src="./right.png" alt="" />
          <p className='text-[17px] font-semibold'>I'm a <b className='text-[22px] font-serif'>fresher</b> and <b>2023</b> year Graduate. <br />
        ...
        <div className="max-sm:flex max-sm:flex-col max-sm:gap-2 max-sm:py-4 max-sm:pb-6 pt-2">
          ...
          <div className="flex flex-row gap-3 items-center pl-7 max-sm:flex-col max-sm:pl-5">
               ...
               <img className='w-12 h-12' src="./mongodb.svg" alt="" />
               <img className='w-12 h-12' src="./express.png" alt="" />
               <img className='w-12 h-12' src="./react.png" alt="" />
               <img className='w-12 h-12' src="./node.png" alt="" />
               </div>
          </div>
        </div>
